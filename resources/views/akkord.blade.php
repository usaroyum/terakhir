...
@include('fullscreen')
	...
	<div class="px-4 xl:px-32 mt-32 grid gap-y-9">
		<div class="flex justify-between items-center">
			<p class="text-4xl font-light text-white">AKKORD</p>
	...
	<section class="other w-screen px-4 xl:px-32 my-20">
		...
		<div class="grid grid-cols-3">
			...
			<div class="col-span-3 xl:col-span-1 grid gap-3">
				...
				<a onmouseover="changeImage()" data-image-id='akkord' href="/fallen-angel"  class="link cursorHover  ">FALLEN ANGEL</a>
				<a onmouseover="changeImage()" data-image-id='godkiller' href="/godkiller"  class="link cursorHover  ">GODKILLER</a>
				<a onmouseover="changeImage()" data-image-id='demon' href="/fantasy-stuff"  class="link cursorHover  ">DAEMON</a>
				</div>
			</div>
