...
<head>
    ...
    <link rel="preload" as="image" href="/assets/image/hero.png">
	<style>
		body{
...
@include('sidebar')
	...
	<section id="gallery" class="section2 py-4 h-full 2xl:h-screen w-screen grid items-center pt-20">
		...
		<div class="slideshow flex justify-between px-10 3xl:px-20 items-center 3xl:pt-12 4xl:pt-24" id="slideshow">
					...
					<button class="prev cursorHover" onclick="plusSlides(-1)"><i class="fas fa-chevron-left text-white font-light  text-xs 2xl:text-base 4xl:text-2xl"></i></button>
					<a href="/godkiller" class="cursorHover mySlides fade grid justify-items-center items-center rounded-xl h-60 2xl:h-64 3xl:h-96 4xl:h-100 5xl:h-103 w-10/12 bg-blend-overlay hover:bg-blue-800  hover:cursor-pointer hover:text-opacity-100" id="showimage">
					...
					<a href="/fantasy-stuff" class=" cursorHover mySlides fade grid justify-items-center items-center rounded-xl h-60 2xl:h-64 3xl:h-96 4xl:h-100 5xl:h-103 w-10/12 bg-blend-overlay hover:bg-blue-800  hover:cursor-pointer hover:text-opacity-100" id="showimage2">
                    ...
                    <a href="/fallen-angel" class=" cursorHover mySlides fade grid justify-items-center items-center rounded-xl h-60 2xl:h-64 3xl:h-96 4xl:h-100 5xl:h-103 w-10/12
                    object-top
                    bg-blend-overlay
                    ...
                    <a href="/long-exile" class=" cursorHover mySlides fade grid justify-items-center items-center rounded-xl h-60 2xl:h-64 3xl:h-96 4xl:h-100 5xl:h-103 w-10/12 bg-blend-overlay hover:bg-blue-800  hover:cursor-pointer hover:text-opacity-100" id="showimage4">
                    ...
                    <a href="/akkord" class=" cursorHover mySlides fade grid justify-items-center items-center rounded-xl h-60 2xl:h-64 3xl:h-96 4xl:h-100 5xl:h-103 w-10/12 bg-blend-overlay hover:bg-blue-800  hover:cursor-pointer hover:text-opacity-100" id="showimage5">
                    ...
                    <a href="/leviathan" class="cursorHover  mySlides fade grid justify-items-center items-center rounded-xl h-60 2xl:h-64 3xl:h-96 4xl:h-100 5xl:h-103 w-10/12 bg-blend-overlay hover:bg-blue-800  hover:cursor-pointer hover:text-opacity-100" id="showimage6">
					...
					<button class="next cursorHover " onclick="plusSlides(1)"><i class="fas fa-chevron-right text-white text-xs 2xl:text-base 4xl:text-2xl"></i></button>

			</div>

			<div class="gallerySlide hidden px-10 3xl:px-20" id="gallery">
			@include('gallery')
			</div>
            ...
            <h1 class=" cursorHover view w-24 4xl:w-40 5xl:w-64 text-xs 2xl:text-sm 3xl:text-base 4xl:text-xl 5xl:text-4xl pb-2 text-white text-center hover:rounded-full" id="showandhide" onclick="slideshow()">View All</h1>
	...
	<section id="contacts" class="h-full 2xl:h-screen w-screen grid items-center px-10 2xl:px-20 3xl:px-24 pt-20">
		...
		<div class="grid grid-cols-1 2xl:grid-cols-2 items-center">
			...
			<div>
				...
				<button class=" cursorHover connect border-2 text-white rounded-lg w-full px-4 font-light mt-4 text-sm  2xl:text-sm 3xl:text-sm 4xl:text-lg 5xl:text-2xl 5xl:h-12" type="submit">Connect with us</button>
					</div>
